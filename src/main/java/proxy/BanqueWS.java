 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.tpjws.com/", wsdlLocation = "http://localhost:8080/tpjws/services?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.tpjws.com/", "BanqueWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/tpjws/services?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.tpjws.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.tpjws.com/", "BanqueServicePort"), BanqueService.class, features);
    }
